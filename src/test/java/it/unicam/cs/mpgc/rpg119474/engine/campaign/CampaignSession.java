...
public class CampaignSession {
    ...
    /**
     * Apre lo scontro della tappa corrente: genera l'avversario e avvia il duello.
     * L'osservatore ricevera' gli eventi di combattimento.
     */
    public void startStage(Observer<CombatEvent> observer) {
        ...
        this.game.startDuel(run.player(), enemy, enemyStrategy, observer);
    }
